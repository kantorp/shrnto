...
const cs = {
  ...
  loading: { title: "Připravuji tvůj brief.", sub: "Obvykle 15–20 sekund", steps: ["Načítám dnešní tisk", "Píšu tvé první shrnutí", "Připravuji rozhraní"] },
  ...
  controls: { langCs: "Čeština", langEn: "English", short: "Krátký", longer: "Delší", formatConsolidated: "Konsolidovaně", formatFleet: "Fleet Sheet" },
...
const en: Dict = {
  ...
  loading: { title: "Preparing your brief.", sub: "Usually 15–20 seconds", steps: ["Loading today's press", "Writing your first summary", "Preparing the interface"] },
  ...
  controls: { langCs: "Czech", langEn: "English", short: "Short", longer: "Longer", formatConsolidated: "Consolidated", formatFleet: "Fleet Sheet" },
